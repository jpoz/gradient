I;21;Foundation/CPObject.jI;29;Foundation/CPKeyValueCoding.jc;4905;
...
},["id","CPCoder"]), new objj_method(sel_getUid("encodeWithCoder:"), function $_CPCibConnector__encodeWithCoder_(self, _cmd, aCoder)
{ with(self)
{
