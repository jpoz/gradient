I;21;Foundation/CPObject.jc;4248;
...
},["void"]), new objj_method(sel_getUid("supportsFullPlatformWindows"), function $CPPlatformWindow__supportsFullPlatformWindows(self, _cmd)
{ with(self)
{
    return NO;
}
