I;20;Foundation/CPArray.jI;21;Foundation/CPObject.jI;21;Foundation/CPString.ji;7;CPCib.ji;17;_CPCibConnector.jc;9753;
...
},["id"]), new objj_method(sel_getUid("mainMenu"), function $_CPCibObjectData__mainMenu(self, _cmd)
{ with(self)
{
...
},["CPMenu"]), new objj_method(sel_getUid("displayVisibleWindows"), function $_CPCibObjectData__displayVisibleWindows(self, _cmd)
{ with(self)
{
    var object = nil,
